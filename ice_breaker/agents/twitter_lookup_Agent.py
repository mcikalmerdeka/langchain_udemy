...
def lookup(name: str) -> str:
    ...
    template = """
    Given the name {name_of_person}, I want you to get back the Twitter profile page, and exract from it their username. 
    Your answer should only contain the username and nothing else.
    """
    ...
    linkedin_url_lookup_tool = Tool(
        name="Crawl Google for Twitter profile page Using Tavily Search",
        func=get_profile_url_tavily,

        # Note that the description is important since that's how the agent will know whether to use the tool or not
        description="Useful when you need to find a person's Twitter profile URL"
    )
